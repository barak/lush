...
#define Xidx_aiaiao(FUNC_NAME, CHECK_FUNC) \
  ...
  { \
    ...
    if((IND_NDIMS(ind1) != IND_NDIMS(ind3)) || (IND_NDIMS(ind1) != IND_NDIMS(ind2))) ERRBADARGS; \
    index_read_idx(ind1, &i1); \
    index_read_idx(ind2, &i2); \
    index_write_idx(ind3, &i3); \
    CHECK_FUNC(&i1, &i2, &i3); \
...
#define Xidx_2i1i1o(FUNC_NAME, CHECK_FUNC) \
  ...
  { \
    ...
    if (arg_number==2) { \
       ind1 = AINDEX(1); \
       ind2 = AINDEX(2); \
       ind3 = make_array(IND_STTYPE(ind1), SHAPE1D(IND_DIM(ind1,0)), NIL); \
       p3 = ind3->backptr; \
    }  else { \
       ARG_NUMBER(3); \
       ind1 = AINDEX(1); \
    ...
    if(IND_NDIMS(ind1) != 2 || IND_NDIMS(ind2) != 1 || IND_NDIMS(ind3) != 1) ERRBADARGS; \
    index_read_idx(ind1, &i1); \
    index_read_idx(ind2, &i2); \
    index_write_idx(ind3, &i3); \
    CHECK_FUNC(&i1, &i2, &i3); \
...
#define Xidx_4i2i2o(FUNC_NAME, CHECK_FUNC) \
  ...
  { \
    ...
    if (arg_number==2) { \
       ...
       IND_NDIMS(ind1) = 2; \
       ind3 = make_array(IND_STTYPE(ind1), IND_SHAPE(ind1), NIL); \
    ...
    if(IND_NDIMS(ind1) != 4 || IND_NDIMS(ind2) != 2 || IND_NDIMS(ind3) != 2) ERRBADARGS; \
    index_read_idx(ind1, &i1); \
    index_read_idx(ind2, &i2); \
    index_write_idx(ind3, &i3); \
    CHECK_FUNC(&i1, &i2, &i3); \
...
#define Xidx_1i1i2o(FUNC_NAME, CHECK_FUNC) \
  ...
  { \
    ...
    if (arg_number==2) { \
       ind1 = AINDEX(1); \
       ind2 = AINDEX(2); \
       if(IND_NDIMS(ind1) != 1 || IND_NDIMS(ind2) != 1) ERRBADARGS; \
       ind3 = make_array(IND_STTYPE(ind1), \
                         SHAPE2D(IND_DIM(ind1, 0), IND_DIM(ind2, 0)), NIL); \
       p3 = ind3->backptr; \
    }  else { \
       ARG_NUMBER(3); \
       ind1 = AINDEX(1); \
       ...
       p3 = APOINTER(3); \
       ind3 = AINDEX(3); \
       if(IND_NDIMS(ind1) != 1 || IND_NDIMS(ind2) != 1 || IND_NDIMS(ind3) != 2) ERRBADARGS; \
    } \
    index_read_idx(ind1, &i1); \
    index_read_idx(ind2, &i2); \
    index_write_idx(ind3, &i3); \
...
#define Xidx_2i2i4o(FUNC_NAME, CHECK_FUNC) \
  ...
  { \
    ...
    if (arg_number==2) { \
       ind1 = AINDEX(1); \
       ind2 = AINDEX(2); \
       if(IND_NDIMS(ind1) != 2 || IND_NDIMS(ind2) != 2) ERRBADARGS; \
       ind3 = make_array(IND_STTYPE(ind1), \
              SHAPE4D(IND_DIM(ind1, 0), IND_DIM(ind1, 1), IND_DIM(ind2, 0), \
                      IND_DIM(ind2, 1)), NIL); \
       p3 = ind3->backptr; \
    }  else { \
       ARG_NUMBER(3); \
       ...
       p3 = APOINTER(3); \
       ind3 = AINDEX(3); \
       if(IND_NDIMS(ind1) != 2 || IND_NDIMS(ind2) != 2 || IND_NDIMS(ind3) != 4) ERRBADARGS; \
    } \
    index_read_idx(ind1, &i1); \
    index_read_idx(ind2, &i2); \
    index_write_idx(ind3, &i3); \
