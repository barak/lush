...
static int regex_execute(char **regsptr, int *regslen, int nregs)
{
   unsigned short c;
...
char *regex_compile(char *pattern, 
...
int regex_exec(short int *buffer, char *string, 
...
int regex_seek(short int *buffer, char *string, char *seekstart, 
